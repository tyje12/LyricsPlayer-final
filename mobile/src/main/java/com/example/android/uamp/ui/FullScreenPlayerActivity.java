...
public class FullScreenPlayerActivity extends ActionBarCastActivity {
    ...
    private Button mTicketmaster;
    private Button mStubhub;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTicketmaster = (Button) findViewById(R.id.ticketBtn);
        mStubhub = (Button) findViewById(R.id.stubBtn);

        mTicketmaster.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("http://www.ticketmaster.com/");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        }));

        mStubhub.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("http://www.stubhub.com/");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        }));
